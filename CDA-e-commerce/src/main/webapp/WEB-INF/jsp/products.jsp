...
<main role="main">
	...
	<div class="container">
		<h1 class="jumbotron-heading">Nos planches :</h1>
	</div>
					...
					<div class="col-md-4">
						<div class="card mb-4 box-shadow">
							...
							<div class="card-body">
								...
								<p class="card-text"
									style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">${product.description}</p>
